...
function generate_train(pde_function;kws...)
    ...
    train_data, test_data = generate_periodic_train_test_Adv2D(args.L_x,args.L_y,args.M_x,args.M_y,args.tspan,args.alp,args.num_sensors,args.num_train_functions,args.num_test_functions,args.num_sol_points);
